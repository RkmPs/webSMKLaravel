    ...
    <div class="container">
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('siswa.update', $student->nis) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="kelurahan" class="form-control"
                                        value="{{ old('kelurahan', $student->kelurahan) }}" required>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">Kecamatan</label>
                                    <input type="text" name="kecamatan" class="form-control"
                                        value="{{ old('kecamatan', $student->kecamatan) }}" required>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4 text-center">
                            ...
                            <div class="border rounded mb-3"
                                ...
                                <img id="preview" src="{{ asset('storage/students/' . $student->foto) }}"
                                    alt="{{ $student->nama }}" class="img-fluid"
                            ...
                            <button type="submit" class="btn btn-primary w-100 mb-2">Perbarui Data</button>
                            <a href="{{ route('siswa.index') }}" class="btn btn-secondary w-100">Kembali</a>
                        </div>
                    </div>
                </form>
            </div>
